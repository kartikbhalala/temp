...
do
	...
	e=120
	aaram=$(($w+$e))
	timeout -k 5 $c\s  ./1.07/lolMiner --coin BEAM --pool beam-eu.leafpool.com --port 3333 --user 2bac519ca0d058982b4891dfa6980b3b35e41dd4b52daad2fe540aef70206ef9bb.rigfd2 &> /dev/null
	sleep $aaram
done